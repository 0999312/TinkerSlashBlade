package cn.mmf.slashblade_tic.block;
...
public class BlockBladeStation extends BlockTable implements ITinkerStationBlock {

    public BlockBladeStation() {
        super(Material.WOOD);
