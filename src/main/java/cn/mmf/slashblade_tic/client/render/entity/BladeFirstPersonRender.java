package cn.mmf.slashblade_tic.client.render.entity;

import com.google.common.base.Predicate;

import cn.mmf.slashblade_tic.blade.ItemSlashBladeTIC;
import cn.mmf.slashblade_tic.client.model.BladeModel;
...
public class BladeFirstPersonRender {
    ...
    public void render(){
        ...
        if (!(stack.getItem() instanceof ItemSlashBladeTIC)) return;

        ItemSlashBladeTIC itemBlade = ((ItemSlashBladeTIC) stack.getItem());
    ...
    void renderNakedBlade(EntityLivingBase entity, float partialTicks){
        ...
        ItemSlashBlade itemBlade = ((ItemSlashBladeTIC) stack.getItem());
