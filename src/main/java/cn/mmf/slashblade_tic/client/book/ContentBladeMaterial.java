...
public class ContentBladeMaterial extends ContentMaterial {
	  public static final String ID = "bladematerial";

	    private transient Material material;

	    public ContentBladeMaterial(Material material) {
	        super(material);
	    ...
	    private void addDisplayItems(ArrayList<BookElement> list, int x) {
	      ...
	      Set<SlashBladeCore> tools = TinkerSlashBladeRegistry.getTools();

	      for(SlashBladeCore tool : tools) {
	        if(tool == null) {
	          continue;
	        }
