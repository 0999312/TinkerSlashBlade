...
public class ContentBlade extends TinkerPage{

	  public static final transient String ID = "blade";
	  ...
	  private transient SlashBladeCore tool;
	  ...
	  public ContentBlade(SlashBladeCore tool) {
	    this.tool = tool;
	  ...
	  public void load() {
	    ...
	    if(tool == null) {
	      tool = TinkerSlashBladeRegistry.getTools().stream()
