...
public final class SlashBladeBuilder {
  ...
  public static ItemStack tryModifyTool(NonNullList<ItemStack> input, ItemStack toolStack, boolean removeItems)
    ...
    if(!appliedModifiers.isEmpty()) {
      ...
      if(copy.getItem() instanceof SlashBladeTICBasic) {
  ...
  public static ItemStack tryReplaceToolParts(ItemStack toolStack, final NonNullList<ItemStack> toolPartsIn, final boolean removeItems)
    ...
    rebuildTool(tag, (SlashBladeTICBasic) output.getItem());
   ...
   *                data.
   */
  public static void rebuildTool(NBTTagCompound rootNBT, SlashBladeTICBasic tinkersItem) throws TinkerGuiException {
    ...
    // fire event
    TinkerSlashBladeEvent.OnItemBuilding.fireEvent(rootNBT, ImmutableList.copyOf(materials), tinkersItem);
